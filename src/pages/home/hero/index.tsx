...
const BG = () => {
    return (
        ...
        >
            ...
            <Rows />
            <div className="aspect-square w-full translate-y-1/4 scale-150 rounded-full bg-[#1B53E2] blur-[6rem]" />
            <div className="aspect-square w-full translate-x-1/2 translate-y-1/3 scale-200 rounded-full bg-[#00EFFE] blur-[6rem]" />
...
const Content = () => {
    return (
        <div className="relative z-20 flex w-full max-w-5xl flex-col items-center justify-center gap-4 text-center text-[#070C39] sm:gap-6 md:mt-8 md:gap-8">
            ...
            <FadeIn delay={1600}>
                <div className="mt-2 flex w-full max-w-md flex-col items-stretch gap-3 sm:max-w-none sm:flex-row sm:items-center sm:justify-center sm:gap-4">
...
const Rows = ({ length = 20 }) => {
    return (
        <div className="absolute bottom-0 left-0 z-10 hidden h-full w-full sm:flex">
